export const vi = {
  ...
  pages: {
    ...
    recruitmentPublic: {
      ...
      printButtonCt02: "CT02 – Đăng ký chữ ký mẫu",
      printButtonCt03: "CT03 – Phiếu đánh giá ứng viên",
      printButtonCt04: "CT04 – Phiếu đánh giá & phê duyệt tuyển dụng",
  ...
  recruitmentForm: {
    ...
    section1: {
      ...
      accountHolderNameMirrored: "Tự động lấy theo Họ và tên ở trên.",
    ...
    section11: {
      ...
      reviewedEntry:
        "Ứng viên xác nhận đã đọc, đối chiếu và đồng ý với toàn bộ thông tin do Quản lý trực tiếp nhập hộ trên hệ thống trước khi ký Phiếu này.",
